 ...
 */
function persona_style_scripts() {

    wp_enqueue_style( 'persona-fonts', persona_fonts_url(), array(), '1.0.0', 'all' );
...
add_action( 'wp_enqueue_scripts', 'persona_style_scripts' );

/*
Register Fonts
 */
function persona_fonts_url() {
    $font_url = '';
     ...
     */
    if ( 'off' !== _x( 'on', 'Google font: on or off', 'persona' ) ) {
