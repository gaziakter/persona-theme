...
<div class="woocommerce-variation-add-to-cart variations_button">
	...
	<button type="submit" class="product-add-cart-btn product-add-cart-btn-3 single_add_to_cart_button button alt<?php echo esc_attr( wc_wp_theme_get_element_class_name( 'button' ) ? ' ' . wc_wp_theme_get_element_class_name( 'button' ) : '' ); ?>">
