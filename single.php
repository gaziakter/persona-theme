                                ...
                                <div class="postbox__main-wrapper">
                                    ...
                                    <div class="postbox__related mb-65">
                                        ...
                                        <div class="row">
                                            ...
                                            // Get the category of current post
                                                    ...
                                                    <div class="blog__item-10 white-bg transition-3 mb-30 fix">
                                                        ...
                                                        <div class="blog__content-10">
                                                            <div class="blog__content-10-top">
                                                                ...
                                                                <p><?php echo wp_trim_words( get_the_content(), 5, '...' ); ?>
                                                                </p>
                                                            </div>
                                                            <div
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div class="blog__meta-author-content-10">
                                                                        <span>By <a
                                                                                href="<?php echo esc_url(get_author_posts_url($author_id)); ?>"><?php echo get_the_author(); ?></a></span>
                                                                    </div>
                                                                </div>
